...
file_path = r'D:\services-workspace\python-scripts\git\html_generator\report.html'
...
def write_content(argument):
    ...
    with open(file_path, "a") as file:
        # Check if the report title exists in the file content before appending additional content
        if not check_report_title():
